...
public class Admin_RegisterDriver extends AppCompatActivity
{
    Button btn2_signup;
    EditText user_name, pass_word,txtName, txtSurname, txtIDNumber, txtCellNumber, txtVehType, txtVehColor, txtVehNumPlate;
    FirebaseAuth mAuth;
                ...
                mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>()
                {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task)
                    {
                        if (task.isSuccessful())
                        {
                            ...
                            user.put("Colour", txtVehColor.getText().toString());
                            ...
                            Toast.makeText(Admin_RegisterDriver.this, "You are successfully Registered", Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(Admin_RegisterDriver.this, Login.class);
                            startActivity(intent);
                        }
                        else
                        {
                            Toast.makeText(Admin_RegisterDriver.this, "You are not Registered! Try again", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
